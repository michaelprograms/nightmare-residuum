...
void create () {
    ...
    set_long("A small street traveling north to south through brick dwellings covered in dark ivy. Several birch trees branch over the street and dwellings. A building with open doors on the east side of the street. A public square can be seen to the south. A framework of hexagons glimmer overhead.");
    set_exits(([
