...
void create() {
    ...
    set_listen(
        "default",
        "Several whispers can be heard from some vagrants hanging around."
    );
    ...
    set_looks(([
        ({
            "crates",
            "goods"
        }): "Old crates positioned around the warehouse are either empty or filled with spoiled goods.",
