...
void create () {
    ...
    set_long("The eastern hallway of a building with high ceilings and polished floors. The walls are made of stone blocks and covered with some tapestries. The hallway turns towards the north as it heads further into the building. The lobby is to the west.");
    set_exits(([
        "west": HUMAN_ROOM + "museum_1.c",
        "north": HUMAN_ROOM + "museum_1_e2.c",
    ]));
    set_looks(([
