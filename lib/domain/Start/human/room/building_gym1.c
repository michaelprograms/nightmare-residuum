...
void create() {
    ...
    set_listen(
        "default",
        "Several warriors talk boisterously while lifting weights."
    );
    ...
    set_looks(([
        ({
            "chairs",
            "equipment"
        }): "Chairs in this sparsely furnished room that are scattered around a few weight training stations.",
        ({
            "door",
            "window"
        }): "The front of the building consists of a door that swings open to the street and a wide window.",
