...
void create() {
    ...
    set_listen(
        "default",
        "Quiet is occasionally broken by a drip into a puddle."
    );
    ...
    set_looks(([
        ...
        ({
            "columns",
            "archways"
        }): "The columns are evenly spaced, with some connecting to form archways, providing support the warehouse floor above.",
    ]));
    set_reset(([
