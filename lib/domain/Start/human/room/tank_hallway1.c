...
void create () {
    ::create();
    set_short("a hallway");
    set_long("The end of a sparse hallway in front of an open tank. A large number one is etched onto the wall next to the tank. The floor is covered in dust with footprints leading to the east.");
    set_exits(([
