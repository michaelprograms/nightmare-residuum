...
void create() {
    ...
    set_listen(
        "default",
        "Quiet interspersed with the occasional thuds of arrows hitting targets."
    );
    set_smell(
        "default",
        "Old masonry mixed with the refreshing scent of wildflowers."
    );
    set_exits(([
    ...
    set_looks(([
        ...
        ({
            ...
            "archway",
            "gate"
        }): "The gated archway is the entrance to this building, which houses the field.",
        ...
        ({
            "archery",
            "targets"
        }): "Targets upon which archers can shoot arrows are setup in the field to the west.",
