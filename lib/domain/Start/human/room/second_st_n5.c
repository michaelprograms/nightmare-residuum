...
void create () {
    ...
    set_long("A small street traveling north to south through brick dwellings covered in dark ivy. Several birch trees branch over the street and dwellings. A large marble building is to the west. A framework of hexagons glimmer overhead.");
    set_exits(([
