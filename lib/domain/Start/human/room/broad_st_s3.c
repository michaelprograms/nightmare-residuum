...
void create () {
    ...
    set_long("A small street traveling north to south through brick dwellings covered in dark ivy. Several birch trees branch over the street and dwellings. A building on the northeast corner of the intersection has benches set up and large open windows. An obelisk can be seen to the north. A framework of hexagons glimmer overhead.");
    ...
    set_looks(([
        "street": "A street sign is labeled S. Broad St. and Walnut St.",
