...
void create () {
    ...
    set_long("The basement floor of a brick building that consists of the personal training area of the paladins. It is a sparsely populated area where the paladins train in an ascetic lifestyle. Wooden floorboards overhead form a crude barrier between the first floor. A staircase leads back down to the first floor.");
