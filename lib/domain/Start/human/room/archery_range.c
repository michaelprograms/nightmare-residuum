...
void create() {
    ...
    set_listen(
        "default",
        "Quiet interspersed with several thuds of arrows hitting targets."
    );
    set_smell(
        "default",
        "The refreshing scent of a wide open green space and wildflowers."
    );
    set_exits(([
    ...
    set_looks(([
        ({
            ...
            "gate",
            "entrance"
        }): "The brick-front and gated archway can be seen to the east, blocking entrance to the street.",
        ...
        ({
            "archery",
            "targets"
        }): "Targets upon which archers can shoot arrows are setup in the field.",
