...
void create () {
    ...
    set_long("A cramped structure made of concrete. A hatch on the south wall allows entry inside of the dome, while another hatch is on the north wall leading out of the dome. Light from the sky is funneled through skylights on the outside of the dome.");
    set_exits(([
        "out south": HUMAN_ROOM + "broad_st_n7.c",
        "out north": HUMAN_ROOM + "broad_st_n9.c",
    ]));
    set_looks(([
