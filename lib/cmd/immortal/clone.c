...
void command(string input, mapping flags) {
    ...
    if (ob->is_living() || ob->query_no_get()) {
        message(
            "action",
            "You clone " + ob->query_cap_name() + " into your environment.",
            this_character()
        );
        message(
            "action",
            this_character()->query_cap_name() + " clones " + ob->query_cap_name() + ".",
        ...
        message(
            "action",
            "You clone " + ob->query_name() + " into your inventory.",
            this_character()
        );
        message(
            "action",
            this_character()->query_cap_name() + " clones " + ob->query_name() + ".",
            environment(this_character()),
            this_character()
        );
