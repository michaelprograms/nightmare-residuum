...
void test_noise_helpers () {
    expect("noise_fade smooths values", (: ({
        assert(testOb->noise_fade(0.0), "==", 0.0),
        assert(testOb->noise_fade(0.20), "==", 0.057920),
        assert(testOb->noise_fade(0.25), "==", 0.103516),
        assert(testOb->noise_fade(0.40), "==", 0.317440),
        assert(testOb->noise_fade(0.5), "==", 0.5),
        assert(testOb->noise_fade(0.60), "==", 0.682560),
        assert(testOb->noise_fade(0.75), "==", 0.896484),
        assert(testOb->noise_fade(0.80), "==", 0.942080),
