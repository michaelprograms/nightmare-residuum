...
void test_query_achievements_from_room() {
    ...
    expect("query_achievements_from_room finds achievements", (: ({
        assert_equal(
            testOb->query_achievements_from_room("/domain/Start/human/room/square.c"),
            ({ ([
        ...
        assert_equal(
            testOb->query_achievements_from_room($(room1)),
            ({ ([
                "description": "Explore the museum's hallways and appreciate the works of art.",
                "flags": "p1,p2,p3,p4,s1,s2,s3,s4",
                "name": "Art Appreciation"
        ...
        assert_equal(
            testOb->query_achievements_from_room("/domain/Nowhere/room/void.c"),
            0
        ),
