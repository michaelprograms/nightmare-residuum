...
void test_query_achievements_from_room () {
    ...
    expect("query_achievements_from_room finds achievements", (: ({
        assert_equal(testOb->query_achievements_from_room("/domain/Start/human/room/square.c"), ({ ([ "description": "Explore the museum's hallways and appreciate the works of art.", "flags": 10, "name": "Art Appreciation" ]) })),
        assert_equal(testOb->query_achievements_from_room($(room1)), ({ ([ "description": "Explore the museum's hallways and appreciate the works of art.", "flags": 10, "name": "Art Appreciation" ]) })),
