...
void create () {
    ansiTerm = ([
        ...
        "WHITE":            ANSI(37),
        // Intense
        "I_BLACK":          ANSI_F(102),    // CCC
        "I_RED":            ANSI_F(196),    // FAA
        "I_GREEN":          ANSI_F(46),     // AFA
        "I_YELLOW":         ANSI_F(226),    // FFA
        "I_BLUE":           ANSI_F(21),     // AAF
        "I_MAGENTA":        ANSI_F(201),    // FAF
        "I_CYAN":           ANSI_F(51),     // AFF
        "I_WHITE":          ANSI_F(231),    // FFF
        // Background
        "B_BLACK":          ANSI(40),
        "B_RED":            ANSI(41),
        "B_GREEN":          ANSI(42),
