...
void test_direct_lock_str_with_obj() {
    expect("direct_lock_str_with_obj returns true", (: ({
        ...
        assert_equal(
            testOb->direct_lock_str_with_obj("direction", "bad key"),
            0
        ),
...
void test_direct_unlock_str_with_obj() {
    expect("direct_unlock_str_with_obj returns true", (: ({
        ...
        assert_equal(
            testOb->direct_unlock_str_with_obj("direction", "bad key"),
            0
        ),
        assert_equal(
            testOb->direct_unlock_str_with_obj("direction", testOb),
            1
        ),
    }) :));
}
