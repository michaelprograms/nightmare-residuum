...
void test_property_single() {
    ...
    expect("add, set, remove, and query property handle bad inputs", (: ({
        assert_catch(
            (: testOb->query_property(UNDEFINED) :),
            "*Bad argument 1 to property->query_property\n"
        ),

        assert_catch(
            (: testOb->set_property(UNDEFINED, UNDEFINED) :),
            "*Bad argument 1 to property->set_property\n"
        ),
        assert_catch(
            (: testOb->set_property("key", UNDEFINED) :),
            "*Bad argument 2 to property->set_property\n"
        ),
        assert_catch(
            (: testOb->set_property("key", ({})) :),
            "*Bad argument 2 to property->set_property\n"
        ),
        assert_catch(
            (: testOb->set_property("key", ([])) :),
        ...
        assert_catch(
            (: testOb->add_property(UNDEFINED, UNDEFINED) :),
            "*Bad argument 1 to property->add_property\n"
        ),
        assert_catch(
            (: testOb->add_property("key", UNDEFINED) :),
            "*Bad argument 2 to property->add_property\n"
        ),
        assert_catch(
            (: testOb->add_property("key", ({})) :),
            "*Bad argument 2 to property->add_property\n"
        ),
        assert_catch(
            (: testOb->add_property("key", ([])) :),
        ...
        assert_catch(
            (: testOb->set_properties(UNDEFINED) :),
            "*Bad argument 1 to property->set_properties\n"
        ),

        assert_catch(
            (: testOb->remove_property(UNDEFINED) :),
