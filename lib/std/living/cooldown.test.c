...
void test_cooldown_heart_beats () {
    expect("heart_beat cooldowns are settable and queryable", (: ({
        ...
        assert_equal(testOb->query_cooldown("test"), ([ "type": "heart_beat", "value": 1 ])),
        ...
        assert_equal(testOb->query_cooldown("test"), ([ "type": "heart_beat", "value": 2 ])),
...
void test_cooldown_timed (function done) {
    expect("timed cooldowns are settable and queryable", (: ({
        ...
        assert_equal(testOb->query_cooldown("test"), ([ "type": "timed", "value": 0.001 ])),
    }) :));
