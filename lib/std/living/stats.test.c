...
void test_query_and_set_stat () {
    ...
    expect("handles setting and querying stats", (: ({
        ...
        assert(testOb->query_stat_base("strength"), "==", 12345),
        assert(testOb->query_stat_base("perception"), "==", 12345),
        assert(testOb->query_stat_base("endurance"), "==", 12345),
        assert(testOb->query_stat_base("charisma"), "==", 12345),
        assert(testOb->query_stat_base("intelligence"), "==", 12345),
        assert(testOb->query_stat_base("agility"), "==", 12345),
        assert(testOb->query_stat_base("luck"), "==", 12345),
        ...
        assert(testOb->query_stat_base("strength"), "==", 321),
        assert(testOb->query_stat_base("perception"), "==", 321),
        assert(testOb->query_stat_base("endurance"), "==", 321),
        assert(testOb->query_stat_base("charisma"), "==", 321),
        assert(testOb->query_stat_base("intelligence"), "==", 321),
        assert(testOb->query_stat_base("agility"), "==", 321),
        assert(testOb->query_stat_base("luck"), "==", 321),
    }) :));
}
...
void test_stat_bonus () {
    ...
    expect("handles setting and querying stats", (: ({
        ...
        assert(testOb->query_stat("strength"), "==", 125),
        assert(testOb->query_stat("perception"), "==", 125),
        assert(testOb->query_stat("endurance"), "==", 125),
        assert(testOb->query_stat("charisma"), "==", 125),
        assert(testOb->query_stat("intelligence"), "==", 125),
        assert(testOb->query_stat("agility"), "==", 125),
        assert(testOb->query_stat("luck"), "==", 125),
        assert(testOb->query_stat_base("strength"), "==", 100),
        assert(testOb->query_stat_base("perception"), "==", 100),
        assert(testOb->query_stat_base("endurance"), "==", 100),
        assert(testOb->query_stat_base("charisma"), "==", 100),
        assert(testOb->query_stat_base("intelligence"), "==", 100),
        assert(testOb->query_stat_base("agility"), "==", 100),
        assert(testOb->query_stat_base("luck"), "==", 100),
        assert(testOb->query_stat_bonus("strength"), "==", 25),
        assert(testOb->query_stat_bonus("perception"), "==", 25),
        assert(testOb->query_stat_bonus("endurance"), "==", 25),
        assert(testOb->query_stat_bonus("charisma"), "==", 25),
        assert(testOb->query_stat_bonus("intelligence"), "==", 25),
        assert(testOb->query_stat_bonus("agility"), "==", 25),
        assert(testOb->query_stat_bonus("luck"), "==", 25),
    }) :));
}